...
- 趣味でLLMを使用して1人で遊べるTRPG(テーブルトークRPG)の開発に取り組んでいます。
- クリエイター用コミュニティーのディスコードbotを開発、管理しています。
- イラストレーターのイラスト作成支援のためのWebアプリケーションの開発、管理をしています。
- 機械学習を使用したBTCの取引用Botを作成しようとして~~精度が低いモデルばかりを生み出し続けています~~
...
面白い技術が大好きなので新旧問わず色んな技術を吸収していきたいです。
